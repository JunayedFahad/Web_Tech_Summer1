...
// Handle form submission for inserting a series
...
<section class="container">
    ...
    <div class="content">
        <form action="" method="post">
            ...
            <input type="text" name="Seasons" placeholder="No of Seasons">
            ...
            if ($serieslist && $serieslist->num_rows > 0) {
                while ($row = $serieslist->fetch_assoc()) {
                    echo "<tr>
                        ...
                        <td>{$row['Seasons']}</td>
                        <td>{$row['Rating']}</td>
                        <td><a class='delete-btn' href='seriesA.php?del={$row['Title']}'>Delete</a></td>
                    </tr>";
                }
            } else {
